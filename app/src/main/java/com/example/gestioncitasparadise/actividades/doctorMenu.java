...
import com.example.gestioncitasparadise.actividades.uiDoctor.ListaCitas.ListaDoctorFragment;
...
public class doctorMenu extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public static void postRegistrarDispositivoEnServidor(String token, Context context, String id){
        ...
        String url = "https://thevalentin.000webhostapp.com/Proyectos/ServidorGestionCitas/RegistrarNotificacionDoctor.php";
