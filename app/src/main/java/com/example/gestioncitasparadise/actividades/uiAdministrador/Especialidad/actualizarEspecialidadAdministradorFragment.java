...
public class actualizarEspecialidadAdministradorFragment extends Fragment {
    ...
    public static actualizarEspecialidadAdministradorFragment newInstance(int data) {
        actualizarEspecialidadAdministradorFragment fragment = new actualizarEspecialidadAdministradorFragment();
